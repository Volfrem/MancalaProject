package Events {
	...
	/**
	 * @author Sergei Laada
	 * send this event when there is a need to start new game
	 */
	public class StartNewGame extends Event {

		//Event name
		public static const EVENT_NAME : String = "StartNewGame";
		 ...
		 */
		public function StartNewGame(_p1name : String, _p2name : String, _p1captured : int, _p2captured : int, _p1inPits : int, _p2inPits : int) {
			super(EVENT_NAME);
		...
		public override function clone() : Event {
			return new StartNewGame(mPlayerOneName, mPlayerTwoName, mPlayerOneCaptured, mPlayerTwoCaptured, mPlayerOneInPits, mPlayerTwoInPits);
		}
